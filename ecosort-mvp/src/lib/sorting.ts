...
export const WASTE_CATEGORIES = {
  PLASTIC: {
    ...
    keywords: ['bottle', 'cup', 'container', 'plastic', 'packaging', 'wrap', 'bin', 'jug', 'tub', 'polyethylene', 'pvc', 'toy', 'bucket']
  },
  METAL: {
    name: 'Metal',
    ...
    keywords: ['can', 'tin', 'aluminum', 'metal', 'foil', 'iron', 'steel', 'screw', 'pot', 'pan', 'alloy', 'wire', 'util', 'tool', 'brass', 'copper']
  },
  PAPER: {
    name: 'Paper',
    ...
    keywords: ['paper', 'cardboard', 'box', 'newspaper', 'magazine', 'book', 'envelope', 'carton', 'flyer', 'folder', 'mail', 'sheet', 'craft', 'tissue']
  },
  GLASS: {
    name: 'Glass',
